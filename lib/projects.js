...
export const projects = [
  {
    ...
    github: "https://github.com/sankthomas/catalogue/tree/main/app/projects/frontend-mentor-projects",
  },
  {
    id: uuidv4(),
    title: "UNESCO World Heritage Sites",
    url: "/projects/unesco-world-heritage-sites",
    description: "World Heritage Sites are cultural and/or natural sites considered to be of \"Outstanding Universal Value\" which have been inscribed on the World Heritage List by the World Heritage Committee. This app uses their API to display this information.",
    category: "API Projects",
    github: "https://github.com/SankThomas/catalogue/tree/main/app/projects/unesco-world-heritage-sites",
  },
  {
    id: uuidv4(),
    title: "Random User Generator",
    url: "/projects/randomuser",
    description:
      "This app uses the RandomUser API to get random fake user profiles.",
    category: "API projects",
    github:
      "https://github.com/SankThomas/catalogue/tree/main/app/projects/randomuser",
  },
  {
    id: uuidv4(),
    title: "GitHub Users",
    url: "/projects/github-users",
    description:
      "This app uses the free version of the GitHub users API to get and show user profiles.",
    category: "API projects",
    github:
      "https://github.com/SankThomas/catalogue/tree/main/app/projects/github-users",
  },
  {
    id: uuidv4(),
    title: "GitHub Users with Auth",
    url: "/projects/github-users-with-auth",
    description:
      "This app uses the paid version of the the GitHub users API to search and show user profiles.",
    category: "API projects",
    github:
      "https://github.com/SankThomas/catalogue/tree/main/app/projects/github-users-with-auth",
  },
  {
    id: uuidv4(),
    title: "Space X Data",
    ...
    category: "API projects",
    github:
      "https://github.com/SankThomas/catalogue/tree/main/app/projects/spacex",
  },
  {
    id: uuidv4(),
    title: "Pokedex",
